...
VERSION = "fandex_master_v3_youtube_content_type"
...
def load_youtube_source(weight, ranking_file):
...
def print_preview(ranking, has_youtube):
    print()
    print("FANDEX master ranking v3 미리보기")
    print("-" * 60)
...
def main():
    print()
    print("FANDEX master score v3 생성 시작")
    print("=" * 60)
    ...
    youtube_source, youtube_data = load_youtube_source(
        weights.get("youtube", 0.0),
        youtube_ranking_file,
    )
    ...
    ranking_timestamp_file = f"fandex_master_ranking_v3_{now}.json"
    report_timestamp_file = f"fandex_master_artist_reports_v3_{now}.json"
    audit_file = f"fandex_master_score_v3_audit_{now}.csv"
    ...
    print()
    print("=" * 60)
    print("FANDEX master score v3 생성 완료")
    print("=" * 60)
