...
SOURCES = [
...

    {
        ...
        "difficulty": "low",
        "pipelineRisk": "low",
        "notes": "v2 완료: 승인 MBID 기반 10명 직접 조회. MBID/name/type/country 검증 전원 통과, ok=10, error=0, warning=0. 아티스트 identity 및 catalog metadata 계층으로 사용하며 FANDEX Master 점수에는 합산하지 않음.",
    },
