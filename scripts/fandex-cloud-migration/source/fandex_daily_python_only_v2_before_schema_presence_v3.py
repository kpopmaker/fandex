...
VERSION = "fandex_daily_python_only_v2_stale_decay_zero_presence_no_site_export"
...
def main():
    ...
    print("주의: Music chart stale decay와 explicit zero presence를 master 생성 전에 공식 반영합니다.")
    print("=" * 60)
    ...
    run_step(step, "Music chart explicit zero presence 공식 반영", "music_chart_zero_presence_from_history_v2.py", ["--apply"], log_rows=log_rows)
    step += 1
