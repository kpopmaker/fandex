...
VERSION = "fandex_daily_python_only_v2_stale_decay_no_site_export"
...
def main():
    ...
    print("주의: Music chart stale decay를 master 생성 전에 공식 반영합니다.")
    print("=" * 60)
    ...
    run_step(step, "Music chart stale decay 공식 반영", "music_chart_apply_stale_decay_v1.py", ["--apply"], log_rows=log_rows)
    step += 1
