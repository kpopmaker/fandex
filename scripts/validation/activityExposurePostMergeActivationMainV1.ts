...
async function main() {
  ...
  try {
    ...
    if (
      ...
      throw new Error('activity_exposure_post_merge_activation_authority_invalid');
    }
    ...
    if (
      ...
      throw new Error('activity_exposure_post_merge_readiness_invalid');
    }
    ...
    if (
      ...
      || activation.approval.authorizedAt !== '2026-09-26T01:00:41.000Z'
      ...
      throw new Error('activity_exposure_post_merge_activation_result_invalid');
    }
    ...
    if (
      ...
      || cutover.decision.directProductionContributionEligible !== false
      || cutover.decision.requiredNextGate !== 'explicit-public-route-cutover'
      ...
      throw new Error('activity_exposure_post_merge_cutover_boundary_invalid');
    }

    console.log('ACTIVITY_EXPOSURE_POST_MERGE_PRODUCTION_ACTIVATION=PASS');
    console.log(JSON.stringify({
      ...
      activation: {
        ...
        authorizationId: activation.approval.activationAuthorizationId,
      ...
      cutoverCandidate: {
        ...
        cutoverAuthorizationId: cutover.pendingApproval.cutoverAuthorizationId,
        ...
        directProductionContributionEligible:
          cutover.decision.directProductionContributionEligible,
        requiredNextGate: cutover.decision.requiredNextGate,
...
main().catch((error) => {
  console.error(
    error instanceof Error
      ? error.message
      : 'activity_exposure_post_merge_production_activation_failed',
  );
  process.exitCode = 1;
});
