-- Activity Exposure v1 persistence schema candidate.
-- VALIDATION ONLY. Do not apply to Neon main without explicit authorization.
...
-- Candidate grants only. Production authorization remains a separate gate.
