...
export const artistUniverseV4: ArtistV4[] = [
  ...
  createArtist({ id: 'jisoo', ticker: 'JISOO', name: 'Jisoo', agency: 'BLISSOO', debutDate: '2016-08-08', entityType: 'solo', fandomName: 'BLINK', generation: '3rd gen', aliases: ['JISOO'], naverNewsQuery: '지수 BLACKPINK solo', koreanAliases: ['지수', '김지수'], englishAliases: ['Jisoo', 'JISOO'], keywords: ['BLACKPINK', 'BLISSOO', 'YG', 'solo'], disambiguationKeywords: ['BLACKPINK', 'YG Entertainment', 'solo'], markets: ['KR', 'US', 'GLOBAL'], tier: 'realtime', priorityScore: 94 }),
  createArtist({ id: 'lisa', ticker: 'LISA', name: 'Lisa', agency: 'LLOUD', debutDate: '2016-08-08', entityType: 'solo', fandomName: 'BLINK', generation: '3rd gen', aliases: ['LISA', 'Lalisa'], naverNewsQuery: '리사 BLACKPINK solo', koreanAliases: ['리사'], englishAliases: ['Lisa', 'LISA', 'Lalisa'], keywords: ['BLACKPINK', 'LLOUD', 'YG', 'solo'], disambiguationKeywords: ['BLACKPINK', 'YG Entertainment', 'solo'], markets: ['KR', 'US', 'SEA', 'GLOBAL'], tier: 'realtime', priorityScore: 95 }),
  createArtist({ id: 'rose', ticker: 'ROSE', name: 'Rosé', agency: 'THEBLACKLABEL', debutDate: '2016-08-08', entityType: 'solo', fandomName: 'BLINK', generation: '3rd gen', aliases: ['Rose', 'ROSÉ'], naverNewsQuery: '로제 BLACKPINK solo', koreanAliases: ['로제', '박채영'], englishAliases: ['Rosé', 'Rose', 'ROSÉ'], keywords: ['BLACKPINK', 'THEBLACKLABEL', 'YG', 'solo'], disambiguationKeywords: ['BLACKPINK', 'YG Entertainment', 'solo'], markets: ['KR', 'US', 'GLOBAL'], tier: 'realtime', priorityScore: 95 }),
