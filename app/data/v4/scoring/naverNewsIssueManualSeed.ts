...
export function createNaverNewsIssueManualSeedSamples(): NaverNewsIssueArtistSeed[] {
  return [
    ...
    },
    {
      ...
      items: [
        createSeedItem({
          id: 'manual-newjeans-001',
          artistId: 'newjeans',
          artistName: 'NewJeans',
          title: 'Fictionalized preview: agency and contract topic remains concentrated',
          issueType: 'contractAgency',
          tone: 'mixed',
          relevanceScore: 8.7,
          ...
          impactScore: 8.3,
          riskScore: 7.2,
          noteKo: '계약/소속 이슈 집중도를 가정한 manual seed입니다.',
          noteEn: 'Manual seed for assumed contract or agency issue concentration.',
        }),
        createSeedItem({
          id: 'manual-newjeans-002',
          artistId: 'newjeans',
          artistName: 'NewJeans',
          title: 'Fictionalized preview: controversy risk headline needs monitoring',
          issueType: 'controversyRisk',
          tone: 'negative',
          relevanceScore: 7.8,
          ...
          impactScore: 7.6,
          riskScore: 8.4,
          noteKo: '논란성 헤드라인 모니터링 필요성을 표현하는 preview seed입니다.',
          noteEn: 'Preview seed for controversy-risk headline monitoring.',
        }),
        createSeedItem({
          id: 'manual-newjeans-003',
          artistId: 'newjeans',
          artistName: 'NewJeans',
