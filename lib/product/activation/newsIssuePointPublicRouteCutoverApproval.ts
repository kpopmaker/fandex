...
export const NEWS_ISSUE_POINT_PUBLIC_ROUTE_CUTOVER_APPROVAL =
  Object.freeze({
    ...
    authorizedAt: '2026-09-23T01:48:12.000Z',
...
const CUTOVER_AUTHORIZATION_RESULT =
  authorizeNewsIssuePointPublicRouteCutover({
...
if (CUTOVER_AUTHORIZATION_RESULT.status !== 'authorized-for-route-cutover') {
  throw new Error('news_issue_point_public_route_cutover_approval_invalid');
}
...
export const NEWS_ISSUE_POINT_PUBLIC_ROUTE_CUTOVER_APPROVAL_EVIDENCE =
  Object.freeze({
    ...
    authority: 'product-operations-owner' as const,
    authorizationEvidenceCommentId: 5787561580 as const,
    authorizedMain:
