...
import type {
  FandexMomentumStoredEvidenceReadAttestation,
} from './fandexMomentumStoredEvidenceAttestationResearch';

export const FANDEX_MOMENTUM_VERIFIER_OUTPUT_ATTESTATION_ADAPTER_RESEARCH_VERSION =
  'v160_fandex_momentum_verifier_output_attestation_adapter_research_v1' as const;

export const FANDEX_MOMENTUM_VERIFIER_OUTPUT_ATTESTATION_ADAPTER_RESEARCH_DESCRIPTOR =
  Object.freeze({
    contractVersion:
      FANDEX_MOMENTUM_VERIFIER_OUTPUT_ATTESTATION_ADAPTER_RESEARCH_VERSION,
    lifecycle: 'research' as const,
    downstreamAttestationContract:
      'v159_fandex_momentum_stored_evidence_read_attestation_payload_v1' as const,
    concreteVerifierExecutionRequired: true as const,
    exactSourceBoundaryRequired: true as const,
    completeJobAndEvidenceReadRequired: true as const,
    materializedPayloadFingerprintsRequired: true as const,
    countOnlyVerifierOutputAccepted: false as const,
    runtimeOnlyVerifierOutputAccepted: false as const,
    callerAssertedReproductionFlagAccepted: false as const,
    prebuiltAttestationAcceptedAsVerifierOutput: false as const,
    priorSourceReuseAccepted: false as const,
...
export type FandexMomentumVerifierOutputAttestationAdapterResult = Readonly<{
  contractVersion:
    typeof FANDEX_MOMENTUM_VERIFIER_OUTPUT_ATTESTATION_ADAPTER_RESEARCH_VERSION;
...
export function adaptFandexMomentumVerifierOutputToStoredEvidenceAttestationResearch(
  input: Readonly<{
