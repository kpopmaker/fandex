...
export const ALBUM_COMPLETED_PURCHASE_PROVIDER_SURVEY_RESEARCH = Object.freeze({
  ...
  candidates: Object.freeze([
    ...
    Object.freeze({
      candidateId: 'oricon-research-biz-online',
      providerClass: 'licensed-data-service' as const,
      constructCompatible: true,
      directProviderObservationAvailable: true,
      unitPhysicalSalesAvailable: true,
      ...
      derivedPublicationRights: 'review-required' as const,
      contractualProductionPath: 'explicitly-offered' as const,
      territoryScope: Object.freeze(['JP']),
      productionCandidateState: 'contract-capable' as const,
      reason: 'Oricon Research explicitly provides a corporate marketing database built from nationwide retailer and e-commerce sales data. ORICON BiZ online exposes daily, weekly and cumulative CD album sales and offers customized period data; Oricon also states that ranking and sales-count data are created and sold for use in websites, print and other materials. Current FANDEX acquisition, storage, publication, exact daily cutoff and revision terms are not authorized or fully documented, so the path is contractual rather than open.',
      evidenceUrls: Object.freeze([
    ...
    Object.freeze({
      candidateId: 'billboard-japan-soundscan',
      providerClass: 'chart-provider' as const,
      constructCompatible: true,
      directProviderObservationAvailable: true,
      unitPhysicalSalesAvailable: true,
      ...
      territoryScope: Object.freeze(['JP']),
      productionCandidateState: 'rights-blocked' as const,
      reason: 'SoundScan Japan derives nationwide estimated physical sales copies from retailer and e-commerce POS data and powers Billboard Japan Top Albums Sales. The construct is compatible, but the bounded official survey has not established a current FANDEX-capable corporate acquisition/storage/derived-publication licence or provider-specific revision contract, so the public chart is not promoted to Production ingestion.',
      evidenceUrls: Object.freeze([
